...
% Fortunately, concurrent improvements in computational power and algorithm
% design mean that reliably quantifying differences in binding strength from
% molecular simulation is now becoming a genuine possibility.
...
strategies as studies progress. For example, % in 
