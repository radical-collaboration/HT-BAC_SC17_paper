...
\begin{table*}[t]
\centering
\caption{Experiment Setup}\label{tab:exp}
...
As we introduce the use-case NAMD and accessory payload
...
invariant across type of payload executed. Their scaling behavior and, to
