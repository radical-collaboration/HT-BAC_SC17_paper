...
design and implementation of % workflow system 
...
workflow systems that are designed to support specific use cases or `locked-in' end-to-end executions. % monolithic workflows.  
