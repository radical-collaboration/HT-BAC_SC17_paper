...
\jhanote{check for consistency: HTBAC scales, or
implementation of ESMACS protocol scales?} \jdnote{done}
...
\jdnote{Not sure, in case yes, https://github.com/radical-cybertools/htbac}
