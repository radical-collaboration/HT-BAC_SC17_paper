...
% exceed 500 words. submitted manuscripts may not exceed ten (10)
...
% The submitted manuscripts should include author names and affiliations. The
% submission portal will be available by September. Return to this site to
% submit your abstract and upload your submissions.
% ---------------------------------------------------------------------------
...
\author{
    ...
    \IEEEauthorblockA{
       \IEEEauthorrefmark{1}Department of Electrical and Computer Engineering, Rutgers University, NJ, USA
    }
    \IEEEauthorblockA{
