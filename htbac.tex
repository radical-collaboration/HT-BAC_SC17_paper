...
system. The ESMACS protocol of the HTBAC workflow enables the 
user to modify the workflow, and define parameters such as the physical 
system, number of replicas, and core allocation per replica. 
...
The concept of an ensemble in the ESMACS protocol maps directly to
