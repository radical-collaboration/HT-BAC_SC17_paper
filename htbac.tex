We begin with an initial design of HTBAC as a special purpose implementation
...
replica in ESMACS maps to a single pipeline in EnTK, consisting of a sequence
of stages. Each stage consists of a task that perform unique functions,
including preprocessing and molecular dynamics simulations.
