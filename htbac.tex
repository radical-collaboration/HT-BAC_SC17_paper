HTBAC is a Python-implemented workflow system that sits between the 
...
can be interacting but as per ESMACS/TIES protocols the replicas
are not required to be interacting.}
...
added a sentence below to address how}
...
In turn, HTBAC provides scalability of protocols to enable multiple, concurrent 
binding affinity investigations of different physical systems and mutations. 
