...
maintain temporal order during execution. \mtnote{The following should be
edited for readability and probably separated into a new paragraph. Note how
we introduce `resource configuration' here and we use it again in the
following paragraph.} The workflow relies on a resource configuration which
