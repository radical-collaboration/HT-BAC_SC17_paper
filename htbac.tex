We begin with an initial design of HTBAC as a special purpose implementation of
...
% Included in the HTBAC workflow expression, the user is able to define and assign
...
% and investigate free energy protocols with a variety of physical systems. HTBAC
...
% \jdnote{I suggest we change the figure then, otherwise the reader will wonder 
% what the Agent and RP DB are.}
