...
the first and last stages perform staging of the input/output data, the
...
accordingly?}. The task is appended to a stage and stages are appended to a
pipeline to maintain temporal order during execution. \mtnote{The following
...
the following paragraph.} The workflow relies on a resource configuration
