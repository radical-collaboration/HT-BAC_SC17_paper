...
assign one or more replica?} \jdnote{better?}. We express the application logic of HTBAC using
...
The concept of % an 
ensemble in the ESMACS and TIES \mtnote{and TIES? You mentioned it above. At some
point we will have to transition to ESMACS only but the transition needs to
be justified.} protocol maps directly to a set of pipelines in EnTK, where each 
